...
// It is the student instance with name Joe
// 2. What is "this" when joe.scopeArrow() is invoked?
// The Window instance
// 3. Explain why "this" is different when an arrow function is used.
// `this` or `super` is not present in arrow functions it's not referring to the student instance.'
// I found this article helpful for understanding arrow functions: https://dmitripavlutin.com/when-not-to-use-arrow-functions-in-javascript/
